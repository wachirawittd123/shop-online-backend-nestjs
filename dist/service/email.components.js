...
exports.EmailComponents = void 0;
const common_1 = require("@nestjs/common");
const bcrypt = require("bcrypt");
const setting_1 = require("../common/setting");
let EmailComponents = class EmailComponents {
    static randCode() {
        return bcrypt.randomBytes(48).toString("hex");
    }
    static formatVerifyEmail({ title, description, subTitle, uri, buttonText, endCredit, unsubText, userEmail }) {
        const styles = `
            /* Reset styles */ 
            body {
            ...
            .button {
                ...
                border-radius:3px;
                color: #fff !important;
                background-color: ${setting_1.SettingService.APP_MAIN_COLOR};
                outline:none;
                font-size:0.85em;
        ...
        const emailContent = `
            ...
            <head>
                ...
                <style>${styles}</style>
                <title>${setting_1.SettingService.APP_NAME}</title>
            </head>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-top: 20px;">
                                                <img border="0" vspace="0" hspace="0" src=${setting_1.SettingService.APP_LOGO} alt=${setting_1.SettingService.APP_NAME} title=${setting_1.SettingService.APP_NAME} width="150" style="border: none; color: #333333; display: block; font-size: 13px; margin: 0; max-width: 150px; padding: 0; outline: none; text-decoration: none; width: 100%; -ms-interpolation-mode: bicubic;" />
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;">
                                                ...
                                                <p style="font-size: 15px; font-weight: 400; line-height: 160%; color: #333333; font-family: 'Prompt', sans-serif;">
                                                    ${endCredit ? setting_1.SettingService.MAIL_FROM : "Thank you"}
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
...
exports.EmailComponents = EmailComponents;
exports.EmailComponents = EmailComponents = __decorate([
    (0, common_1.Injectable)()
], EmailComponents);
//# sourceMappingURL=email.components.js.map